...
export default function Home() {
  ...
  return (
    /*
     * `screen` = h-full flex flex-col overflow-hidden (defined in index.css)
     * Fills the exact device viewport, no scroll.
     * Content is centred vertically with justify-center + flex-1 spacers.
     */
    <div className="screen bg-[#f4f5f0]">
      <div className="flex-1 flex flex-col justify-center px-6 max-w-md w-full mx-auto py-12">
